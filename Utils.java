...
import static dev.flankstack.Constants.KAFKA_PREFIX;
import static dev.flankstack.Constants.K_KEYSTORE_PASSWORD;
import static dev.flankstack.Constants.K_PROPERTIES_FILE;
import static dev.flankstack.Constants.K_SCHEMA_REG_SSL_CLIENT_KEY;
import static dev.flankstack.Constants.K_SCHEMA_REG_URL;
import static dev.flankstack.Constants.K_TRUSTSTORE_PASSWORD;
import static dev.flankstack.Constants.K_TRUSTSTORE_PATH;
import static dev.flankstack.Constants.MASK;
import static dev.flankstack.Constants.SENSITIVE_KEYS_KEY;
...
//			//System.out.println("Job Param: {}={}", key, isSensitive(key, params) ? MASK : params.get(key));
//			//LOG.info
//		}
		return params;
	}
	...
	public static Properties readKafkaProperties(ParameterTool params) {
		...
		try {
			properties.put( "kafka.bootstrap.servers","edge2ai-1.dim.local:9092" );
			properties.put( "bootstrap.servers", "edge2ai-1.dim.local:9092" );
			properties.put( "group.id", "flinkKafkaGroup" );
		} catch (Exception e) {
			e.printStackTrace();
		}
...
//		}
	...
	public static Map<String, Object> readSchemaRegistryProperties(ParameterTool params) {
		...
		schemaRegistryConf.put( KafkaAvroSerializer.STORE_SCHEMA_VERSION_ID_IN_HEADER, "true");
